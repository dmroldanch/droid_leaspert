...
import com.iteneum.AmenitieModel
...
class CommunityListViewModel : ViewModel() {
    ...
    var amenitiesList: MutableList<AmenitieModel> = mutableStateListOf()
        private set
...
/* RESPONSE EXAMPLE */
val response: DataState<List<AmenitieModel>> = DataState.Success(
    listOf(
        AmenitieModel(
            id = 1,
