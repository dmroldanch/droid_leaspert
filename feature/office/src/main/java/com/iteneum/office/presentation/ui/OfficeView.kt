...
fun OfficeUI(
    ...
    Scaffold(content = { paddingValues ->
        val schedule = officeData.schedule
        val address = officeData.address
        val email = officeData.email
        val phone = officeData.phone
        ...
        Box(modifier = Modifier.padding(paddingValues)) {
            Column(
                ...
                LPBodyMedium(modifier = Modifier.padding(top = sizes.extraSize10),
                    ...
                    onClick = {})
                LPBodyMedium(modifier = Modifier.padding(top = sizes.extraSize10),
                    label = stringResource(id = R.string.LPHours) + schedule,
                    color = MaterialTheme.colorScheme.onPrimaryContainer,
                    textAlign = TextAlign.Justify,
                    onClick = {})
